            ...
            >
                <div className="max-w-lg">
                    <div className="text-center font-bold mb-8">
                        <h2 className="text-6xl text-gray-800">Streamline</h2>
                        <span className="mt-4 text-4xl text-gray-800">your workflow</span>
                    </div>
                    <img
            ...
            >
                <div className="w-full max-w-md space-y-8">
                    <div className="text-left">
                        <h2 className="text-3xl sm:text-4xl font-bold text-gray-800">Get started for free</h2>
                        <p className="mt-2 text-gray-600 text-lg">Create your account</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="relative">
                            ...
                            {errors.fullname?.lastname && (
                                <p className="text-red-500 text-sm mt-1">{errors.fullname.lastname.message}</p>
                            )}
                        </div>
